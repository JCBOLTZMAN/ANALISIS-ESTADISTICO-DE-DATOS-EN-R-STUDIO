...
## Definir funciones en R {background-image="https://github.com/JCBOLTZMAN/ANALISIS-ESTADISTICO-DE-DATOS-EN-R-STUDIO/blob/main/cursos/img/5.png?raw=true" background-size="10%" background-position="top left"}

Una función en R es un conjunto de instrucciones o comandos finitos, ordenados que en conjunto responden a una necesidad de cálculo.

Por ejemplo: _matrix(argumentos)_ Es una función que genera una matriz con las caracteristicas especificadas en los argumentos, _colSums(argumentos)_ Suma los valores de los datos de cada columna de una matriz.

## Definir funciones en R {background-image="https://github.com/JCBOLTZMAN/ANALISIS-ESTADISTICO-DE-DATOS-EN-R-STUDIO/blob/main/cursos/img/5.png?raw=true" background-size="10%" background-position="top left"}

Los _argumentos_ son los datos que requiere la función para poder realizar sus operaciones, los argumentos son diferentes para cada función.

Los usuarios pueden definir funciones nuevas para resolver alguna acción que el usuario requiera utilizando el siguente código: __nombre = function(arg1,arg2,arg3,...){listas de comandos}__
...
El código anterior genera una función llamada __suma(a,b)__ como argumentos pide dos datos y los datos internamente los suma y regresa el valor de la suma con la funcion __return()__, para usar la función es suficiente con escribir el nombre de dicha función y agregar sus argumentos en la consola o en un apartado de código
